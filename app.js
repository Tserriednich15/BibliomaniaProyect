...
const cardWidth = 300 + 20; // 300px tarjeta + 20px gap
let scrollPosition = 0;

// Botón izquierdo
btnLeft.addEventListener('click', () => {
  scrollPosition = Math.max(scrollPosition - cardWidth * 5, 0); // Asegura que no pase de 0
...
btnRight.addEventListener('click', () => {
  ...
  scrollPosition = Math.min(scrollPosition + cardWidth * 3, maxScroll); // Limita hasta el final
  sectionContent.style.transform = `translateX(-${scrollPosition}px)`;
