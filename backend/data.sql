#Creamos si no existe el usuario node_js lo restringimos a solo peticiones en forma local y le asignamos la contraseña #Aprendiz2025
CREATE USER IF NOT EXISTS "node_js"@"localhost" IDENTIFIED BY "Aprendiz2024";

#Creamos la base de datos
CREATE DATABASE bibliomania CHARACTER SET utf8mb4;

#Asignamos la base de datos al usuario y le damos todos los permisos
GRANT ALL PRIVILEGES ON bibliomania.* TO "node_js"@"localhost";
